...
A arquitetura da AWS espera que todas as equipes sejam capazes de criar arquiteturas seguindo as melhores práticas. Para capacitar novas equipes ou elevar os padrões das existentes, há acesso a uma comunidade virtual de engenheiros-chefes que analisam projetos e orientam sobre as melhores práticas da AWS. Essa comunidade trabalha para tornar as melhores práticas visíveis e acessíveis, por exemplo, através de palestras na hora do almoço, que são gravadas e podem ser usadas como material de integração.

As melhores práticas da AWS são baseadas na experiência da empresa na execução de sistemas em escala da internet, utilizando dados e a expertise de engenheiros-chefes para defini-las. À medida que novas práticas são identificadas, a comunidade de engenheiros-chefes assegura que sejam adotadas pelas equipes. Com o tempo, essas práticas são incorporadas aos processos internos de análise e mecanismos de conformidade. O Well-Architected Framework é uma implementação voltada para o cliente desse processo interno, codificando o pensamento de engenharia nas funções de campo.
